      ...
      <div className="grid gap-8 md:grid-cols-2 items-start">
        <div>
          ...
          <p className="text-xl text-zinc-300 mb-6">
            ...
            business operations and drive growth in the digital economy.
          </p>
          <div className="space-y-6 mt-8">
            <div className="p-6 bg-zinc-900 rounded-lg border border-zinc-800">
              ...
              <p className="text-zinc-300">
                Evaluate digital maturity and define a transformation roadmap
                through stakeholder interviews and current tool assessment.
              </p>
            ...
            <div className="p-6 bg-zinc-900 rounded-lg border border-zinc-800">
              ...
              <p className="text-zinc-300">
                Establish or optimize online sales platforms using Shopify or
                WooCommerce with integrated payment gateways like Paystack and
                Flutterwave.
              </p>
              <ul className="mt-4 space-y-2 text-zinc-300">
                <li className="flex items-start">
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 bg-zinc-900 rounded-lg border border-zinc-800">
            ...
            <p className="text-zinc-300">
              Implement cloud-based tools and integrate Customer Relationship
              Management/Enterprises Resource Planning systems for operational
          ...
          <div className="p-6 bg-zinc-900 rounded-lg border border-zinc-800">
            ...
            <p className="text-zinc-300">
              Protect digital assets through security audits, staff training,
              and policy development aligned with Nigerian regulations.
            </p>
            <ul className="mt-4 space-y-2 text-zinc-300">
              <li className="flex items-start">
                <span className="mr-2">•</span>
